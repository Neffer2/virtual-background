export const effectsList = {
  ...
  //       label: 'Flappy Plane',
  //       effects: [
  //         {name: 'FlappyPlane_mouth.zip'}
  //       ]
  //     },
  //     what_animal_are_you: {
  //       label: 'What Animal Are You',
  //       effects: [
  //         {name: 'What_Animal_Are_You.zip', control: 'game'},
  //       ]
  //     },
  //   }
  // },
    ...
    categories: {
      background_separation: {
        ...
        effects: [
          ...
          {name: 'Background_change.zip', icon: 'video_BG_RainyCafe.png'},
        ],
      },
  ...
  //       label: 'Skin',
  //       effects: [
  //         {name: 'SkinSoftening.zip', control: 'slider', params: ['Skin.softening'], minValue: 0, direction: 1},
  //       ]
  //     },
  //     eye_whitening: {
  //       label: 'Eye Whitening',
  //       effects: [
  //         {name: 'EyesWitening_Toggle.zip', control: 'toggle', params: ['onDataUpdate']}
  //       ]
  //     },
  //     tooth_whitening: {
  //       label: 'Tooth Whitening',
  //       effects: [
  //         {name: 'TeethWitening_Toggle.zip', control: 'toggle', params: ['onDataUpdate']}
  //       ]
  //     },
  //   }
  // },
  ...
  //       label: 'Analytics',
  //       effects: [
  //         {name: 'heart_rate.zip', control: 'analise', params: ['onDataUpdate()']}
  //       ]
  //     },
  ...
  //       effects: [
  //         {name: 'test_Ruler.zip', control: 'analise', params: ['onDataUpdate()']}
  //       ]
  //     },
  //     eye_segmentation: {
  ...
  //       effects: [
  //         {name: 'TrollGrandma.zip'}
  //       ]
  //     },
  //     multiple_face_detection: {
  //       label: 'Multiple Face Detection',
  //       effects: [
  //         {name: 'MinnieMouse7_multi.zip'}
  //       ]
  //     },
  //     physics: {
  //       label: 'Physics',
  //       effects: [
  //         {name: 'ConfusedRabbit.zip'},
  //       ],
  //     },
  //     triggers: {
  //       label: 'Triggers',
  ...
  //       effects: [
  //         {name: 'Detection_gestures.zip', control: 'analise', params: ['getGesture()']}
  //       ]
  //     },
  //     rings_try_on: {
  //       label: 'Rings try on',
